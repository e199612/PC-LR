...
f_train = open("ali_train_4days", "r")
uid_dict = {}
mid_dict = {}
cat_dict = {}
...
pkl.dump(uid_voc, open("uid_voc_4days.pkl", "wb"),2)
pkl.dump(mid_voc, open("mid_voc_4days.pkl", "wb"),2)
pkl.dump(cat_voc, open("cat_voc_4days.pkl", "wb"),2)
