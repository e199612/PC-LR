...
train_file = os.path.join(get_data_prefix(), "local_train_splitByUser_4days")
test_file = os.path.join(get_data_prefix(), "local_test_splitByUser_4days")
...
# uid_voc = "../data/c_uid_voc.pkl"
# mid_voc = "../data/c_mid_voc.pkl"
# cat_voc = "../data/c_cat_voc.pkl"
# item_info = os.path.join(get_data_prefix(), 'item-info')
# reviews_info = os.path.join(get_data_prefix(), 'reviews-info')
...
def test(train_file=train_file,
   ...
   # sample_io
    ...
    print('test_auc: %.4f ----test_loss: %.4f ---- test_accuracy: %.4f ---- test_aux_loss: %.4f' % eval_model(eval_sess, test_ops))
